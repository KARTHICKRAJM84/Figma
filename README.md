...
color: black;
 ...
 <div style="width: 100%; height: 100%; position: relative; background: white">
    ...
    <div style="width: 286px; height: 495px; left: 48px; top: 189px; position: absolute; color: black; font-size: 24px; font-family: Inter; font-weight: 800; word-wrap: break-word"> 1 .  Bharatanatyam  <br/> <br/> 2 . Freestyle <br/><br/>3 . Folk <br/><br/>4 . Semi - Classical <br/><br/>5 . Hip pop <br/><br/>6 . Kathakali</div>
</div>
...
color: black;
 ...
 <div style="width: 100%; height: 100%; position: relative; background: white">
    ...
    <div style="width: 213px; height: 43px; left: 32px; top: 533px; position: absolute; color: black; font-size: 24px; font-family: Inter; font-weight: 800; word-wrap: break-word">PHONE NO</div>
</div>
...
color: #3B37F4;
 ...
 word-wrap: break-word
---
// CONTACT US <br/>www.saveetha.ac.in<br/>8448484888
color: black;
 font-size: 24px;
 font-family: Inter;
 font-weight: 800;
 ...
 <div style="width: 100%; height: 100%; position: relative; background: white">
    ...
    <div style="width: 315px; height: 127px; left: 41px; top: 549px; position: absolute; text-align: center; color: black; font-size: 24px; font-family: Inter; font-weight: 800; word-wrap: break-word">CONTACT US <br/>www.saveetha.ac.in<br/>844848488</div>
</div>
```


## OUTPUT:
![alt text](<Screenshot 2024-05-08 230640.png>)
